...
with open('tags.txt', encoding='utf-8') as file:
    ...
    for line in content:
        ...
        training_data.append((list(line['text']), line['tags'].split()))

# Make up some training data


test_data = [("the wall georgia tech is a in georgia").split()]
...
tag_to_ix = {"LOC": 0, "ORG": 1, "PER": 2, "O": 3, START_TAG: 4, STOP_TAG: 5}
...
for epoch in range(
    ...
    print("epoch is {}!,time is {}".format(epoch,datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')))
